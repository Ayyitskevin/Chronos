...
VCP-2: the 2026-09-22 paragraph carries the record through #258. Each paragraph is pinned on
...
HEADER_2026_09_22 = "**Partial delivery (updated 2026-09-22, through #258 / main e608a09):**"
...
def test_1_every_landed_item_is_a_merged_pr_with_a_merge_sha_and_an_artifact_in_the_tree() -> None:
    ...
    assert sorted(numbers) == list(range(248, 259)), pairs
