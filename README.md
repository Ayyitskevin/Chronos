...
assets, upgrades a disposable v2 database through the installed migration namespace and validates
its schema, and exercises the `chronos` console entry point plus every packaged
