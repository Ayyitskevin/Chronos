...
| 5 | Suite green with exactly one skip (the opt-in IBKR smoke test); ruff/format/mypy-strict clean. ~~Expect ~2489 passed as of 2026-08-02~~ **Corrected 2026-08-09: expect ~2745 passed** after the Five-Tool research slice merged (2543 at `721d7f1`, +202 from the slice and its merge-review tests) — authoritative baseline and suite map: `chronos-validation-and-qa` §2. | `.venv/bin/pytest -q` (~120 s) |
...
| Suite green, 1 skip (~~~2489 passed as of 2026-08-02~~ **corrected 2026-08-09: ~2745**, post Five-Tool merge; baseline home: `chronos-validation-and-qa` §2) | `.venv/bin/pytest -q` |
