...
at a stricter 4/min, runs oldest-first, and records empty pre-horizon chunks as
skips. First-run verification items for hourly: actual depth horizon per symbol,
