...
gains. Phase 0 has not exited: the exact signal window/price/equality convention,
initialization, protective exits, CVaR return/window-inclusion/NAV-composition/rebalance
