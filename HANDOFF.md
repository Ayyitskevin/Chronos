...
midnight, and blocks rather than passes when the count cannot be taken). **R-27 remains
open** — option deliverable verification still comes only from the demo broker — and must be
closed before the option family is promoted. The dormant second submission path (R-28) is
**quarantined**, not retired.
